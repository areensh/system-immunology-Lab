...
**Expanded clone count.** We examined the number of expanded clones at three expansion thresholds: 20, 50, and 100 unique sequences per clone (**Figure 3**). At the lowest threshold (>20 unique sequences), all 94 individuals had at least one expanded clone, confirming that clonal expansion is a universal feature of BCR repertoires regardless of disease status. However, the number of expanded clones varied dramatically: COVID Naive individuals had a median of 521 expanded clones (range 328–920), while Mild individuals had a median of only 9 (range 0–2,117). At the threshold level, 21 of 27 Severe, 9 of 9 Moderate, but only 18 of 41 Mild individuals had ≥10 expanded clones; all 12 Recovered, all 8 COVID Naive, and all 9 Healthy individuals exceeded this count. Raising the threshold to >50 unique sequences began to separate the groups further: 4 Severe and 11 Mild individuals lost all expanded clones, while COVID Naive and Healthy individuals retained multiple expanded clones at this stricter cutoff. At the most stringent threshold (>100 unique sequences), the separation became more pronounced — only 9 of 27 Severe, 3 of 9 Moderate, and 2 of 41 Mild individuals retained any expanded clones, while 11 of 12 Recovered, all 8 COVID Naive, and 8 of 9 Healthy individuals still had ≥100-sequence clones. This threshold-dependent pattern suggests that while low-level expansion is ubiquitous, sustained large-scale clonal expansion is more characteristic of non-disease repertoires.
