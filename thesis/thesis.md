...
![Figure 16. Clone count per tissue for each HC1 healthy donor. Each subplot shows one individual; bars represent the number of distinct clones in each of the seven HC1 tissues (PBL, BM, SPL, Lung, Colon, Ileum, MLN). Y-axis is uniform across all subplots.](../immunedb_STATS_API/clonal_analysis/plots/14_within_subject_clone_count.png){ width=100% }
