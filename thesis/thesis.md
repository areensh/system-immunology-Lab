...
![Figure 9. Somatic hypermutation — all clones by disease stage. (A) CDR NS/S ratio per individual. (B) FW NS/S ratio (same y-axis scale as A). (C) average NS and S mutation counts as stacked bars for CDR and FW regions. Boxplots show median and IQR; dashed line marks NS/S = 1.0. Kruskal-Wallis p-values annotated. Blood samples only.](../immunedb_STATS_API/clonal_analysis/plots/21a_mutations_all_clones.png){ width=100% }
