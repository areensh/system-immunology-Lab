...
Across all clones (**Figure 9A–C**), CDR NS/S ratios were consistently above 1.0 in all disease categories, confirming positive selection in antigen-binding regions. The Kruskal-Wallis test revealed significant differences across groups (p < 0.001): Mild (median 2.93) and Severe (2.89) individuals had the highest CDR NS/S ratios, while Moderate cases showed markedly lower ratios (1.79), with highly significant pairwise differences between Moderate and both Mild (p < 0.001) and Recovered (p < 0.01). COVID Naive (2.62) and Healthy (2.68) individuals showed intermediate CDR NS/S ratios. FW NS/S ratios (**Figure 9B**) were markedly lower than CDR ratios and also showed significant differences across disease categories (Kruskal-Wallis p = 0.002), with Recovered individuals (1.89) having significantly higher FW NS/S than Healthy individuals (1.30, p < 0.001). **Figure 9C** shows that absolute mutation counts were highest in Recovered individuals, consistent with extensive somatic hypermutation in memory B cells following infection and vaccination.
...
**NS/S ratios indicate ongoing selection in disease states.** The CDR NS/S ratios above 1.0 across all disease categories confirm that positive selection is active in CDR regions, consistent with antigen-driven affinity maturation. Moderate individuals showed notably depressed CDR NS/S ratios (median 1.79) compared to all other groups, with highly significant pairwise differences versus Mild (p < 0.001) and Recovered (p < 0.01). This may indicate less efficient germinal center responses in moderate COVID-19, or alternatively a predominance of recently activated naive B cells with fewer accumulated mutations. FW NS/S ratios were also significantly different across groups (p = 0.002), with Healthy individuals showing the lowest FW NS/S (1.30), consistent with stronger purifying selection maintaining framework structural integrity in the absence of disease-driven perturbation. The expanded vs. rest clone analysis revealed a particularly interesting pattern: in active disease (Severe, Mild), expanded clones had lower CDR NS/S ratios than unexpanded clones, suggesting rapid expansion outpacing affinity maturation, while in Recovered, COVID Naive, and Healthy individuals the reverse was true — expanded clones showed higher CDR NS/S ratios, consistent with well-matured memory B cells. The dramatic elevation of FW NS/S ratios in expanded clones from non-diseased individuals (COVID Naive: 2.99 vs. rest: 1.14; Healthy: 2.83 vs. 1.07) suggests that long-lived memory clones accumulate framework structural adaptations that may be tolerated or even beneficial over time.
