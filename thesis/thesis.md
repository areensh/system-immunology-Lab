...
The within-individual analysis (**Figure 18**) showed that even after normalizing for the number of biological samples per tissue, clone counts vary substantially across tissues within the same healthy donor, with peripheral blood (PBL) typically harboring the most clones per sample. The cross-study gut tissue comparison (**Figures 19–20**) revealed differences in clone size distributions between healthy donors and post-transplant patients in shared gut tissues (Colon, Jejunum, MLN), consistent with the distinct immunological environments of native versus post-transplant gut mucosa. The ability to make such comparisons across independently built databases — without manual data harmonization — demonstrates the practical utility of IS-API for multi-study immune repertoire analysis.
