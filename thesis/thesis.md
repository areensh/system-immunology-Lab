...
**Clonal diversity decreases in actively diseased individuals.** The Hill number analysis showed that individuals with active COVID-19 (Mild, Moderate, and Severe) had substantially lower clonal diversity than COVID Naive and Recovered individuals across all three diversity orders (**Figure 2**). Mild individuals showed the lowest diversity, followed by Severe and Moderate. This likely reflects the focusing of the B cell repertoire during an active immune response — antigen-driven clonal expansion leads to the dominance of a few clones, reducing overall diversity. Similar observations of reduced diversity during active immune responses have been reported in individual studies [28, 32].
